...
class AIService {
    ...
    async generateMatchInsights(profile1, profile2) {
        try {
            ...
            const sharedLoveLanguages = profile1.loveLanguage.filter((lang) => profile2.loveLanguage.includes(lang));
